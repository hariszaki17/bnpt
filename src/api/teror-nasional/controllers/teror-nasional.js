...
/**
 * teror-nasional controller
 */

const { createCoreController } = require('@strapi/strapi').factories;

module.exports = createCoreController('api::teror-nasional.teror-nasional', ({ strapi }) => ({
    async find(ctx) {
        let res = await strapi.entityService.findMany('api::teror-nasional.teror-nasional', {
            populate: '*',
        });
        ...
        for (let i = 0; i < res.length; i++) {
            ...
            const obj = {
                ...
                berita: data.berita,
                pengelompokan_aksi_teror: data.pengelompokan_aksi_teror,
            }
